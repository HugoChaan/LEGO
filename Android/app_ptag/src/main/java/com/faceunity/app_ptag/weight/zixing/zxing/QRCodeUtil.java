...
public class QRCodeUtil {
     ...
     * @return BitMap
     * 调用：createQRCodeBitmap(content, 800, 800,"UTF-8","H", "1", Color.BLACK, Color.WHITE);
     */
    public static Bitmap createQRCodeBitmap(String content, int width, int height,
        ...
        Log.d("QRCodeUtil", "createQRCodeBitmap: "+content);
        try {
            /** 1.设置二维码相关配置 */
     ...
     * @param color_black            黑色色块
     * @param color_white            白色色块
     * @param logoBitmap             logo图片 ：Resources res = getResources();
     *                                          Bitmap logoBitmap= BitmapFactory.decodeResource(res,R.mipmap.logo);
     * @param logoPercent            logo所占百分比
     * @return
     * 调用：createQRCodeBitmap(content, 800, 800,"UTF-8","H", "1", Color.BLACK, Color.WHITE,logoBitmap,0.2F);
     */
