...
class FunctionDemoFragment : Fragment() {
    ...
    private val ptaRenderer = CreateRendererUseCase.build()
    ...
    private fun initView() {
        binding.removeCamera.setOnClickListener {
            DevDrawRepository.getSceneOrNull()?.cameraAnimation?.setAnimation(null)
        }
        ...
        binding.setCamera.setOnClickListener {
            ...
            DevDrawRepository.getSceneOrNull()?.cameraAnimation?.setAnimation(FUAnimationBundleData(fullPath))
        }
        binding.setCameraByDataCenter.setOnClickListener {
            ...
            DevDrawRepository.getSceneOrNull()?.cameraAnimation?.setAnimation(FUAnimationBundleData(path))
        }
        ...
        binding.setAnimationBySceneConfig.setOnClickListener {
            val avatarInfo = DevAvatarManagerRepository.getCurrentAvatarInfo() ?: return@setOnClickListener
            val sceneInfo = DevSceneManagerRepository.filterGenderDefaultSceneFirst(avatarInfo.gender()) ?: return@setOnClickListener
        ...
        binding.setBackground.setOnClickListener {
            ...
            DevDrawRepository.getSceneOrNull()?.setBackground(FUBundleData(fullPath))
        }
        binding.setBackgroundByExecutor.setOnClickListener {
            val fullPath = "OSSAssets/GAssets/2dsprite/background/bg_yuanlin.bundle"
            val executor = FrameActionExecutor()
            executor.setSceneBackground(DevDrawRepository.getSceneOrNull()!!, FUBundleData(fullPath))
        ...
        ptaRenderer.apply {
            ...
            bindListener(object : OnGLRendererListener {
                ...
                override fun onSurfaceChanged(width: Int, height: Int) {
                    ptaRenderer.setEmptyTextureConfig(FURendererTextureConfig(width, height, 30)) //渲染依据实际分辨率设置
                }
