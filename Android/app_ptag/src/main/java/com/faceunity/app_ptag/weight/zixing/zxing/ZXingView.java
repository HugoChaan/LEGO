...
import com.faceunity.app_ptag.weight.zixing.core.BGAQRCodeUtil;
...
public class ZXingView extends QRCodeView {
    ...
    protected ScanResult processBitmapData(Bitmap bitmap) {
        return new ScanResult(QRCodeDecoder.syncDecodeQRCode(bitmap),bitmap);
    }
    ...
    protected ScanResult processData(byte[] data, int width, int height, boolean isRetry) {
        ...
        return new ScanResult(result,data);
    }
